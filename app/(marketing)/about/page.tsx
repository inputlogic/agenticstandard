      ...
      <div className="container frame" id="main">
        ...
        <section className={s.hero}>
          <HeroDrift>
            ...
            <p className={`${s.lead} rise`} style={{ animationDelay: '0.36s' }}>
        ...
        <section className={s.section}>
          ...
          <div className={s['founders-grid']}>
            {founders.map((f, i) => (
              <ScrollReveal key={f.name} as="article" delay={i * 80} className={s.founder}>
                <div className={s['founder-photo']}>
                  <Parallax speed={[-0.04, 0.04, -0.04][i]} maxShift={20}>
                    <Image
                      src={f.img}
                      alt={f.name}
                      width={800}
                ...
                <div className={s['founder-info']}>
                  ...
                  <span className={s.role}>Founder</span>
                  <p className={s.bio}>{f.bio}</p>
                  <div className={s['linkedin-wrap']}>
                    <a
                      href={f.linkedin}
                      target="_blank"
