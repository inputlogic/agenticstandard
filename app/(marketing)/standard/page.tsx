...
export const metadata = {
  title: 'The Agentic Standard — What We Believe',
...
const tenets = [
  {
    ...
    body: [
      ...
      "We don't sell technology. The technology is here, and getting better whether or not we exist. We build the bridge between the technology and the operating model that has to meet it. That's the work no one else is doing, and it's the work that matters most.",
    ],
  },
  {
    num: '02',
  ...
  },
  {
    ...
    body: [
      "Most organizations treat AI governance as friction, something legal slows down. We see the opposite. Bounded autonomy is what lets agents move. Without scope, every action needs approval; with scope, action becomes routine.",
  ...
  return (
    <div className="container frame" id="main">
      ...
      <section className={s.hero}>
        <SectionLabel accent>Our Beliefs</SectionLabel>
        <h1 className={s['hero-title']}>The Agentic <em>Standard</em>.</h1>
        <div className={s['hero-subtitle']}>
          What we believe about agentic AI inside the enterprise, and the standard we hold ourselves to inside every engagement.
        </div>
      </section>
      ...
      <section className={s.section}>
        <div className={s.reading}>
          ...
          <p>
            This document is what we believe, why we believe it, and the standard we hold ourselves to.
          </p>
        </div>
      </section>
      ...
      <section className={s['tenets-intro']}>
        <div className={s.reading}>
          ...
          <h2 className={s['tenets-intro-heading']}>What we believe.</h2>
          <p className={s['tenets-intro-lead']}>
            Each of these rejects a common failure mode in the consulting industry. Beyond aspirations, they are the operating principles we will be judged on inside every engagement.
          </p>
        </div>
      </section>
      ...
      <section className={s.promise}>
        <div className={s.reading}>
          ...
          <h2 className={s['promise-heading']}>What we owe you.</h2>
      ...
      <CtaSection
        ...
        sub="A forty-five-minute call. No pitch deck. We ask about the work your team does, where AI has and hasn't stuck, and whether The Foundation fits. The SOW arrives within forty-eight hours if it does."
      />
    </div>
  )
}
